...
renderText({
  ...
  out <- "The points provide the cleaster view of the data, at the cost of showing little else, you don't get the ease of cluster interpretation that text gives you or the outliers that 3D does, but the hover text helps (it was annoying to setup). "
  }
  out
})
```
